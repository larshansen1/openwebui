...
### Production (.env)
```bash
POSTGRES_PASSWORD=zxoVqsAuDSyvjzi0qbXanLwLz+PMb6Z7V6bkDMbv2sY=
WEBUI_SECRET_KEY=773e15e1cf2a2ea35157df04abdd2ea99cc7c267ffd7d9d5c767107d84274646
OPENAI_API_KEY=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
QDRANT_API_KEY=
BRAVE_API_KEY=BSAly1a1cVf4PorjnnwseTDEagwfyRI
RAG_EMBEDDING_MODEL=all-minilm
MCP_API_KEY=mcp-secret-key-change-me
```
